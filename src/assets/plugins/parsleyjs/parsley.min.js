...
(function ($) {
  window.ParsleyValidator
    .addValidator('validcnpj', function (value, requirement) {
      ...
      var validaCnpj = validacnpj(value);
    ...
    .addMessage('pt-br', 'validcnpj', 'Este campo deve ser um CPF/CNPJ válido.');
