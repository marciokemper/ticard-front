...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#68a2b9', '#ff9800', "#f5707a"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#4bd396', '#ebeff2', "#68a2b9"]);
    },
    //init
