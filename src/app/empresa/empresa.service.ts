...
export class EmpresaService {
  ...
  getCharacters(): Array<IOption> {
    return this.cloneOptions(EmpresaService.PLAYER_ONE);
  }

  loadCharacters(): Observable<Array<IOption>> {
    return this.loadOptions(EmpresaService.PLAYER_ONE);
  }

  getCharactersWithDisabled(): Array<IOption> {
    let characters: Array<IOption> = this.cloneOptions(EmpresaService.PLAYER_ONE);
  ...
  getCharactersWithMarked(): Array<IOption> {
    let characters: Array<any> = this.cloneOptions(EmpresaService.PLAYER_ONE);
  ...
  getCountries(): Array<IOption> {
    return this.cloneOptions(EmpresaService.COUNTRIES);
  }

  loadCountries(): Observable<Array<IOption>> {
    return this.loadOptions(EmpresaService.COUNTRIES);
  }
